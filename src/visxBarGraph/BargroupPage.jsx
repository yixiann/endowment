...
const BargroupPage = () => {
    ...
    const vw = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) - 40
    const vh = Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0)- 380
    ...
    }, [fourSevenFive, guranteed, threeTwoFive])
    ...
    const marksArray = guranteed.map((item)=>([guranteed.indexOf(item), item.time]))
    ...
    return (
        <div style={{padding: '20px'}}>
            <Row>
                <Col span={22}><Title>Endowment Plan</Title></Col>
                <Col span={2}>
                    <LegendOrdinal 
            ...
            <BargroupClusterChart width={vw} height={vh/3} data={guranteedData? guranteedData: guranteed}/>
            <Title level={4}>Illustrated at 3.25% investment return</Title>
            <BargroupClusterChart width={vw} height={vh/3} data={threeTwoFiveData? threeTwoFiveData: threeTwoFive}/>
            <Title level={4}>Illustrated at 4.75% investment return</Title>
            <BargroupClusterChart width={vw} height={vh/3} data={fourSevenFiveData? fourSevenFiveData: fourSevenFive}/>
            <Slider 
                range
                onChange={onChange}
                defaultValue={[0, 36]}
